<h1 style="color:red;">Employee Management</h1>
...
<div class="container" style="margin-top:30px">
    <div class="row">
        ...
        <a href="/MVC1/employeeController/addEmployee"><span class="btn btn-xs btn-primary pull-right">+ Add new employee</span></a>
    </div>
        ...
        <tbody>
            <?php
               ...
               foreach($employee as $emp)
               {
                   ...
                   echo "<td class='text-center'><a class='btn btn-info btn-xs' href='/MVC1/employeeController/edit/" . $emp->getId() . "' ><span class='glyphicon glyphicon-edit'></span> Edit</a> <a href='/MVC1/employeeController/remove/" . $emp->getId() . "' class='btn btn-danger btn-xs'><span class='glyphicon glyphicon-remove'></span> Del</a></td>";
                   echo"</tr>";
               }
