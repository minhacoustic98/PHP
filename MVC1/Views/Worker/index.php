<h1 style="color:red;">Worker Management</h1>
...
<div class="container" style="margin-top:30px">
    <div class="row">
        ...
        <a href="/MVC1/workerController/addWorker"><span class="btn btn-xs btn-primary pull-right">+ Add new worker</span></a>
    </div>
        ...
        <tbody>
            ...
            if(isset($worker)){
               ...
               foreach($worker as $emp)
               {
                   ...
                   echo "<td>".$emp->getLevel()."</td>";
                   echo "<td>".$emp->getDate()."</td>";
                   echo "<td>".$emp->getRange()."</td>";
                   echo "<td class='text-center'><a class='btn btn-info btn-xs' href='/MVC1/workerController/edit/" . $emp->getId() . "' ><span class='glyphicon glyphicon-edit'></span> Edit</a> <a href='/MVC1/workerController/remove/" . $emp->getId() . "' class='btn btn-danger btn-xs'><span class='glyphicon glyphicon-remove'></span> Del</a></td>";
                   echo"</tr>";
               }
