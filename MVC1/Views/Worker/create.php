...
<a href="/MVC1/workerController/index" class="btn btn-success btn-xs pull-left">Go back</a>
<form method='post' action='#'>
    ...
    <div class="form-group">
        ...
        <input type="text" value="" name="level" id="level"  placeholder="Enter level" class="form-control">
